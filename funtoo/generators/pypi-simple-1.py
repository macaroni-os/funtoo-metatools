...
async def add_ebuild(hub, json_dict=None, **pkginfo):
	...
	ebuild = hub.pkgtools.ebuild.BreezyBuild(**local_pkginfo, artifacts=artifacts, template_text=pkgutil.get_data('funtoo.generators', "templates/pypi-simple-1.tmpl").decode('utf-8'))
	ebuild.push()
