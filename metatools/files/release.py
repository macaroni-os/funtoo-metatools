...
# TODO: KitKind.SOURCED is not used enough
class KitKind(Enum):
...
class Kit:
	...
	def get_kit_packages(self):
		if self.kind != KitKind.AUTOGENERATED:
			raise TypeError("Invalid attempt to get packages list on non-autogenerated kit.")
